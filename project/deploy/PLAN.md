...
1. **Панель NeoBrain** — сайты, файлы/редактор, чат (DeepSeek)
...
| Сайт `ai` → **NeoBrain** | витрина + бренд NeoBrain |
| Домен сайта 2 | **neobrain.site** (DNS ок; SSL: enable-neobrain.sh) |
| Панель HTTPS | **panel.neobrain.site** (нужен A panel) |
