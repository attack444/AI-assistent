...
<section class="section" id="faq">
  <div class="wrap narrow">
    ...
    <div class="faq">
      ...
      <details class="reveal">
        <summary>Как сообщить об ошибке или идее?</summary>
        <p>Внизу любой страницы — блок «Идея или ошибка?», также кнопка «Идея» в шапке. Это не заявка на SEO: мы читаем сообщения и улучшаем сайт.</p>
      </details>
    </div>
  </div>
</section>
