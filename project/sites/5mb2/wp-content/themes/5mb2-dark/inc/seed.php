...
function mb2_ensure_core_pages() {
    ...
    mb2_upsert_page(
        'o-nas',
        'О проекте 5MB2',
        '<p><strong>5MB2 Digital</strong> — SEO-услуги для бизнеса: аудит, продвижение, Local SEO.</p>'
        . '<p>Работаю как <strong>самозанятый</strong> (налог на профессиональный доход, 422-ФЗ): прозрачные условия, чек в «Мой налог», без НДС.</p>'
        . '<p>Процесс: диагностика → стратегия → реализация → рост. Клиенты видят прогресс в личном кабинете.</p>'
        . '<p><a href="' . esc_url(home_url('/#contact')) . '">Обсудить задачу</a> · <a href="' . esc_url(home_url('/oferta/')) . '">Оферта</a></p>'
    );
}
