...
function mb2_seo_page_map() {
    ...
    return [
        'home' => [
            ...
            'desc'  => 'SEO-аудит, продвижение и Local SEO для бизнеса. Фикс-цены от 29 000 ₽, оплата картой, кабинет с чеклистом, самозанятый (НПД).',
        ],
        'services' => [
            'title' => 'Услуги SEO: аудит, продвижение, Local SEO | ' . $brand,
            'desc'  => 'Каталог SEO-услуг 5MB2: аудит 29 000 ₽, продвижение 55 000 ₽/мес, Local SEO, техника. Оплата картой или заявка.',
        ],
        'instrumenty' => [
