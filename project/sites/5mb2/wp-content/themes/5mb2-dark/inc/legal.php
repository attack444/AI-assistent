...
<p>На сайте указаны фиксированные цены стандартных пакетов (оплата картой через ЮKassa) и возможность индивидуального объёма по заявке. НДС не облагается (режим НПД). При оплате картой чек формируется через ЮKassa; при оплате по реквизитам — чек в «Мой налог».</p>
