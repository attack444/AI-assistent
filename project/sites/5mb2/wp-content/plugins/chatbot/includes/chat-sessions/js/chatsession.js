			...
			$.post(
				...
				function(data){
					...
					$.each( datas, function( key, value ) {
						var row = '<div class="sld_payment_row body"><div class="sld_payment_cell"><input type="checkbox" name="sessions[]" class="wpbot_sessions_checkbox" value="'+value.id+'"></div><div class="sld_payment_cell">'+value.date+'</div><div class="sld_payment_cell">'+value.interaction+'</div><div class="sld_payment_cell">'+value.session_id+'</div><div class="sld_payment_cell">'+value.name+'</div><div class="sld_payment_cell">'+value.email+'</div><div class="sld_payment_cell">'+value.phone+'</div><div class="sld_payment_cell"><div class="sld_responsive_head">Action</div><a href="/wp-admin/admin.php?page=wbcs-botsessions-page&amp;userid='+value.id+'" class="button-primary">View Chat</a> <a href="/wp-admin/admin.php?page=wbcs-botsessions-page&amp;userid='+value.id+'&amp;act=delete" class="button-primary" onclick="return confirm('+sure+')">Delete</a></div></div>';
