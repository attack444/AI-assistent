...
/* Conversational Forms Plugins */
    ...
    if ( $data && ! is_wp_error( $data ) ) {
        $qcld_plugininstal['seo-help'] = $data;
        $qcld_plugininstal['seo-help']->name = 'AI content generator and autoblogging SEO Help';
    }
?>
