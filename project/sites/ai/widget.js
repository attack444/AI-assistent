...
(function (global) {
  ...
  function css() {
    return [
      ...
      "border:1px solid rgba(118,185,0,.22);border-radius:16px;overflow:hidden;",
      "box-shadow:0 24px 60px rgba(0,0,0,.45),0 0 40px rgba(118,185,0,.12);}",
      ...
      ".aih-bot{background:#121c14;border:1px solid rgba(118,185,0,.18);align-self:flex-start;}",
      ".aih-user{background:#76b900;color:#041004;align-self:flex-end;}",
      "#aih-form{display:flex;gap:8px;padding:10px;border-top:1px solid rgba(118,185,0,.15);background:#0a0f0b;}",
      "#aih-form input{flex:1;border:1px solid rgba(118,185,0,.22);border-radius:10px;padding:10px;font:inherit;background:#0d120e;color:#e8f5e9;}",
      "#aih-form button{border:0;border-radius:10px;padding:10px 12px;background:#76b900;color:#041004;cursor:pointer;font:600 13px Manrope,sans-serif;}",
      "#aih-chips{display:flex;flex-wrap:wrap;gap:6px;padding:8px 12px;background:#0a0f0b;}",
      "#aih-chips button{border:1px solid rgba(118,185,0,.25);background:#121c14;border-radius:999px;padding:6px 10px;",
      "font:500 11px Manrope,sans-serif;cursor:pointer;color:#e8f5e9;}",
    ].join("");
  }
